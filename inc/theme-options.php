...
$radio_options = array(
    'banner' => array(
        'value' => 'banner',
        'label' => __('Banner', 'ungpirat')
    ),
    'nivoslider' => array(
        'value' => 'nivoslider',
        'label' => __('Nivo Slider', 'ungpirat')
    ),
);
...
function theme_options_do_page() {
    ...
    <div class="wrap">
    <?php screen_icon();
    echo "<h2>" . get_current_theme() . __(' Theme Options (In development)', 'ungpirat') . "</h2>"; ?>
        ...
        <form method="post" action="options.php">
            ...
            <table class="form-table">
                 ...
                 */ /*
                ?>
                <tr valign="top"><th scope="row"><?php _e('', 'ungpirat'); ?></th>
                    <td>
                        ...
                        <label class="description" for="ungpirat_theme_options[selectinput]"><?php _e('', 'ungpirat'); ?></label>
                    </td>
                </tr>
                ...
                */ /**
                 ...
                 */ /*
                  ?>
                  <tr valign="top"><th scope="row"><?php _e( 'Nivo Slider or Banner', 'ungpirat' ); ?></th>
                  <td>
                  <fieldset><legend class="screen-reader-text"><span><?php _e( 'Would you prefer a nivo slider or a banner', 'ungpirat' ); ?></span></legend>
                  <?php
                  if ( ! isset( $checked ) )
                  $checked = '';
